<%@ Page Title="" Language="C#" MasterPageFile="~/MasterFiles/Home.Master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="PomeSurveyApplication.Forms.Users" %>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">ADD Users
                    ...
                    <div class=" panel-body">
                        <div class="form">
                            <fieldset class="span6 reset">
                                <div class="form_row">
                                    <div class="input">
                                        <input placeholder="User Name" type="text" name="txtuname" id="txtuname" />
                            ...
                            <fieldset class="span6">
                                ...
                                <div class="form_row">
                                    <div class="input">
                                        <input placeholder="Fill out your Contact Number" name="txtcnum"  type="text" id="txtcnum" />
                                        <label class="label" for="company">Contact #:</label>
                                    </div>
                                </div>
                                <div class="form_row">
                                    <div class="input">
                                        <select class="select2" id="ddlroles" name="ddlroles">
