<%@ Page Title="" Language="C#" MasterPageFile="~/MasterFiles/Home.Master" AutoEventWireup="true" CodeBehind="Pharmacist.aspx.cs" Inherits="PomeSurveyApplication.Forms.Pharmacist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="wraper container-fluid">
        <div class="page-title">
            <h1 class="title">Gaviscon Representator</h1>
        </div>
        <div class="panel">
            <div class=" panel-body">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="m-b-30">
                            <h3 class="panel-title">Gaviscon Representator Detail List</h3>
                        </div>
                    </div>
                </div>
                <div id="tableappend">
            ...
            <div class="col-md-12" id="Insertform">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Add Gaviscon Representator </h3>
                    </div>
                    <div class="panel-body">
                        <div class="form">
                            <fieldset class="span6 reset">
                                <div class="form_row">
                                    <div class="input">
                                        <input placeholder="Fill out your name" type="text" name="txtname" id="txtname" />
                                ...
                                <div class="form_row">
                                    <div class="input">
                                        <input placeholder="Fill out your city" name="txtname" type="text" id="txtcity" />
                                ...
                                <div class="form_row">
                                    <div class="input">
                                        <select class="select2" id="ddlhospitals" name="ddlhospital" style="border-radius: 10px">
                                ...
                                <div class="form_row">
                                    <div class="input">
                                        <input placeholder="Fill out your NIC" type="text" name="txtnic" id="txtnic" />
                                        <label class="label" for="website">CNIC:</label>
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="span6">
                                <div class="form_row">
                                    <div class="input">
                                        <input placeholder="Fill out your Password" name="txtpass"  type="password" id="txtpass" />
                                        <label class="label">Password: <span class="blue">*</span></label>
                                    </div>
                                </div>
                                <div class="form_row">
                                    <div class="input">
                                        <input placeholder="Fill out your contact number" name="txtnumber" type="tel" id="txtnumber" />
                                        <label class="label" for="tel">Number: <span class="blue">*</span></label>
                                    </div>
                                </div>

                                <div class="form_row">
                                    <div class="input">
                                        <input placeholder="Fill out your Domain" type="text" name="txtDomain" id="txtDomain" />
                                        <label class="label" for="subject">Domain: <span class="blue">*</span></label>
                                    </div>
                                </div>
                                  <div class="form_row">
                                    <div class="input">
                                            <input class="form-control" placeholder="Date Of Birth" id="datepicker" style="border: 1px solid #ccc; width: 100%; border-radius: 8px" name="datepicker" />
                            ...
                            <fieldset class="span12 reset">
                                <div class="form_row">
                                    <div class="input">
                                        <textarea placeholder="Fill out your address" id="txtaddress"  name="address"></textarea>
                                        <label class="label" for="address">Address: <span class="blue"></span></label>
                                    </div>
                                </div>

                                <div class="form_row">
                                    <a onclick="InsertPharmacistData()" id="btninsert" class="more wider">Insert</a>
                                    <a onclick="UpdatePharmacistData()" id="btnUpdate" style="display:none" class="more wider">Update</a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageEndScripts" runat="server">
    ...
    <script src="../Scripts/Pharmacist.js"></script>
