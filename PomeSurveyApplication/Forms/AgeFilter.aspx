<%@ Page Title="" Language="C#" MasterPageFile="~/MasterFiles/Home.Master" AutoEventWireup="true" CodeBehind="AgeFilter.aspx.cs" Inherits="PomeSurveyApplication.Forms.AgeFilter" %>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="m-b-30">
                            <h3 class="panel-title">Age Filters Details</h3>
                        </div>
                    </div>
                </div>
                <div id="tableappend">
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Add Age Filters: </h3>
                    </div>
                    <div class=" panel-body">
                        <div class="form">
                            <fieldset class="span6 reset">
                                <div class="form_row">
                                    <div class="input">
                                        <input placeholder="Enter the Age Filter" type="text" name="txtage" id="txtage" />
                                        <label class="label" for="name">Age: <span class="blue">*</span></label>
                                    </div>
                                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageEndScripts" runat="server">
    ...
    <script src="../Scripts/AgeFilter.js"></script>
